...
namespace util
{
    ...
    struct Dataset
    {
        ...
        std::vector<std::vector<double>> inputs;  /* Matrix with the inputs of the problem */   //Changed by me
        std::vector<std::vector<double>> outputs; /* Matrix with the outputs of the problem */  //Changed by me
    };
    ...
    std::vector<double> maxDatasetInputs(Dataset *dataset);
    // Get a vector of minimum values of the dataset inputs
    std::vector<double> minDatasetInputs(Dataset *dataset);
